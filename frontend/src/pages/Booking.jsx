...
export default function Booking() {
  ...
  const handleSubmit = async (e) => {
    ...
    setSubmitting(true);
    try { await createBooking({ serviceId, ...formData }); toast.success('Booking created! 🎉'); navigate('/dashboard'); }
    catch (error) { toast.error(error.response?.data?.message || 'Failed to create booking'); }
